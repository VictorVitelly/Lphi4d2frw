...
set ylabel 'S(μ^2)' font ',22' offset -3,0 rotate by 0
...
plot for [i=1:nn] 'm02vssphi.dat' u 1:col1[i]:col2[i] w errorbars title sprintf('t=%.0f',tt[i]) linestyle i, 'magnet.dat' w errorbars title 'Full lattice', 'magnetization.dat' w lines title 'PBC',
pause -1
