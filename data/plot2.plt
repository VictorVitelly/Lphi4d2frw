...
plot for [i=1:nn] 'm02vsphi.dat' u 1:col1[i]:col2[i] w errorbars title sprintf('t=%.0f',tt[i]) linestyle i, 'magnet.dat' w errorbars title 'Full lattice', 'magnetization.dat' w lines title 'PBC',
pause -1
